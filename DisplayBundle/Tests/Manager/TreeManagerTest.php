...
class TreeManagerTest extends AbstractBaseTestCase
{
    ...
    public function provideNodesAndTrees()
    {
        ...
        $superRootNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $rootNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $otherRootNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $childNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $childNode2 = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $otherChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $grandChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $grandChildNode2 = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $otherGrandChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $grandGrandChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $otherGrandGrandChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $fourthDescendantNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
        ...
        $brotherGrandChildNode = Phake::mock('OpenOrchestra\ModelInterface\Model\ReadNodeInterface');
