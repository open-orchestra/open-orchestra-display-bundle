...
use PHPOrchestra\DisplayBundle\Form\Type\AutocompleteSearchType;
...
class SearchStrategy extends AbstractStrategy
{
    ...
    public function show(BlockInterface $block)
    {
        ...
        return $this->render(
            'PHPOrchestraDisplayBundle:Block/Search:show.html.twig',
            array(
    ...
    public function showBack(BlockInterface $block)
    {
        ...
        return $this->render(
            'PHPOrchestraDisplayBundle:Block/Search:showBack.html.twig',
            array(
                'form'   => $form->createView(),
            )
        );
